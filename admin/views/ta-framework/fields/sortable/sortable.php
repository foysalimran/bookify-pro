 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'BOP_Field_sortable' ) ) {
	class BOP_Field_sortable extends BOP_Fields {
		...
		public function render() {
			...
			echo '<div class="bop-sortable" data-depend-id="' . esc_attr( $this->field['id'] ) . '">';
			...
			foreach ( $pre_sortby as $key => $field ) {
					...
					echo '<div class="bop-sortable-item">';

					echo '<div class="bop-sortable-content">';
					...
					BOP::field( $field, $field_value, $unique_id, 'field/sortable' );

					echo '</div>';

						echo '<div class="bop-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
