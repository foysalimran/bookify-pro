...
if ( ! class_exists( 'BOP_Field_gallery' ) ) {
  class BOP_Field_gallery extends BOP_Fields {
    ...
    public function render() {
      ...
      echo '<a href="#" class="button button-primary bop-button">'. $args['add_title'] .'</a>';
      echo '<a href="#" class="button bop-edit-gallery'. esc_attr( $hidden ) .'">'. $args['edit_title'] .'</a>';
      echo '<a href="#" class="button bop-warning-primary bop-clear-gallery'. esc_attr( $hidden ) .'">'. $args['clear_title'] .'</a>';
