...
if ( ! function_exists( 'bop_get_google_fonts' ) ) {
  function bop_get_google_fonts() {
    return [
      ...
      'Hachi Maru BOP'=>[['normal'],['cyrillic','japanese','latin','latin-ext']],
      ...
      'Mochiy BOP One'=>[['normal'],['japanese','latin']],
      'Mochiy BOP P One'=>[['normal'],['japanese','latin']],
      ...
      'BOPpins'=>[['100','100italic','200','200italic','300','300italic','normal','italic','500','500italic','600','600italic','700','700italic','800','800italic','900','900italic'],['devanagari','latin','latin-ext']],
