 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'BOP_Field_column' ) ) {

	/**
	 * The column field class.
	 */
	class BOP_Field_column extends BOP_Fields {
		...
		public function render() {
			...
			$args = wp_parse_args(
				...
				array(
					...
					'lg_desktop_placeholder'       => esc_html__( 'Large Desktop', 'bookify-pro' ),
					'desktop_placeholder'          => esc_html__( 'Desktop', 'bookify-pro' ),
					'tablet_placeholder'           => esc_html__( 'Tablet', 'bookify-pro' ),
					'mobile_landscape_placeholder' => esc_html__( 'Mobile Landscape', 'bookify-pro' ),
					'mobile_placeholder'           => esc_html__( 'Mobile', 'bookify-pro' ),
