	...
	class BOP_Setup {
		...
		public static function field( $field = array(), $value = '', $unique = '', $where = '', $parent = '' ) {
			...
			if ( ! empty( $field['_notice'] ) ) {
				...
				$field            = array();
				$field['content'] = esc_html__( 'Oops! Not allowed.', 'bookify-pro' ) . ' <strong>(' . esc_attr($field_type) . ')</strong>';
				$field['type']    = 'notice';
				$field['style']   = 'danger';
			...
			echo '<div class="bop-field bop-field-' . esc_attr($field_type . $is_pseudo . $class . $visible) . '"' . wp_kses_post($depend) . '>';
			...
			if ( ! empty( $field_type ) ) {
				...
				if ( ! empty( $field['title'] ) ) {
					...
					echo ( ! empty( $field['subtitle'] ) ) ? '<div class="bop-subtitle-text">' . esc_html($field['subtitle']) . '</div>' : '';
					echo '</div>';
				}
