	...
	class BOP_Shortcoder extends BOP_Abstract {
		...
		public function __construct( $key, $params = array() ) {
			...
			if ( ! empty( $this->args['show_in_editor'] ) ) {
				...
				BOP::$shortcode_instances[] = wp_parse_args(
					array(
						'name'     => 'bop/' . $name,
		...
		<div class="bop-modal-table">
			...
			<div class="bop-modal-inner">
				...
				<div class="bop-modal-insert-wrapper hidden"><a href="#" class="button button-primary bop-modal-insert"><?php echo esc_html($this->args['insert_title']); ?></a></div>
			</div>
			</div>
		</div>
		</div>
