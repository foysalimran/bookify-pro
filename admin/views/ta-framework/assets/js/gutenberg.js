...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.bop_gutenberg_blocks ) { return; }

  Object.values(window.bop_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'bop-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary bop-shortcode-button',
              onClick: function () {
                window.bop_gutenberg_props = props;
              },
            }, block.button_title ),
