...
(function($) {
  ...
  function BOPAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  BOPAjaxChosen.prototype.init = function() {
  ...
  BOPAjaxChosen.prototype.events = function() {
  ...
  BOPAjaxChosen.prototype.search_field_focused = function() {
  ...
  BOPAjaxChosen.prototype.search_welcome_message = function() {
  ...
  BOPAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('bop-chosen', _this.options.data).done( function( response ) {
  ...
  BOPAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.bop-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.BOPChosenOrder($hidden_value, true);
  ...
  $.fn.BOPAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new BOPAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, BOPAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  BOPAbstractChosenOrder = (function() {

    function BOPAbstractChosenOrder() {}

    BOPAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    BOPAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    BOPAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    BOPAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    BOPAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    BOPAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    BOPAbstractChosenOrder.BOPChosenOrder = function(select, order, force) {
  ...
  $.fn.extend({
    BOPChosenOrder: function(order, force) {
      return _BOPChosenOrder.BOPChosenOrder(this, order, force);
    }
  });

  this._BOPChosenOrder = (function(_super) {
    __extends(_BOPChosenOrder, _super);

    function _BOPChosenOrder() {
      _ref = _BOPChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _BOPChosenOrder.relAttributeName = 'data-option-array-index';

    _BOPChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _BOPChosenOrder.getDOMElement = function(element) {
    ...
    _BOPChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _BOPChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _BOPChosenOrder;

  })(BOPAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('bop-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectBOP = FormSerializer.serializeObject;
    $.fn.serializeJSONBOP   = FormSerializer.serializeJSON;
  }
