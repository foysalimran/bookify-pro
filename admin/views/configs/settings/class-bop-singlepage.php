		...
		BOP::createSection(
			...
			array(
				...
				'fields' => array(
					...
					array(
						'type'    => 'subheading',
						'content' => __('Book Meta Color', 'bookify-pro'),
					),
					array(
						'id'        => 'bop_single_book_meta_icon',
						'type'      => 'color',
						'title'     => __('Icon Color', 'bookify-pro'),
						'default'   => '#222',
					...
					array(
						...
						'type'      => 'color',
						'title'     => __('Label Color', 'bookify-pro'),
						'default'   => '#222',
					...
					array(
						...
						'type'      => 'color',
						'title'     => __('Value Color', 'bookify-pro'),
						'default'   => '#687279',
					...
					array(
						...
						'type'      => 'typography',
						'title'     => __('Meta Typography', 'bookify-pro'),
						'default'    => array(
							'color'              => '#444',
							'font-family'        => '',
							'font-weight'        => '',
					...
					array(
						'type'    => 'subheading',
						'content' => __('Book Rating Color', 'bookify-pro'),
					),
					array(
