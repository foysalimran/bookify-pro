				...
				'fields' => array(
					...
					array(
						...
						'fields'   => array(
							...
							array(
								'id'         => 'bop_event_fildes',
								'class'      => 'bop_event_fildes ta-product-not-fields',
								'type'       => 'accordion',
								'accordions' => array(
									array(
										...
										'fields' => array(
											...
											array(
												...
												'fields'  => array(
													array(
														...
														'placeholder' => esc_html__('Select a meta', 'bookify-pro'),
														'options'  => array(
															'venue'     => esc_html__('Venue', 'bookify-pro'),
															'organizer'     => esc_html__('Organizer', 'bookify-pro'),
															'price'     => esc_html__('Price', 'bookify-pro'),
															'event_time'     => esc_html__('Event Time', 'bookify-pro'),
														),
													),
													array(
														'id'      => 'venue_map_link',
														'type'    => 'switcher',
														'title'   => esc_html__('Show Map Link', 'bookify-pro'),
														'class'   => 'venue_map_link',
														'title_help'   => esc_html__('Set show map link.', 'bookify-pro'),
														'default' => true,
													...
													array(
														...
														'type'    => 'radio',
														'title'   => esc_html__('Date Type', 'bookify-pro'),
														'class'   => 'event_fildes_date_type',
														'options' => array(
															'start_date' => esc_html__('Start Date and Time', 'bookify-pro'),
															'end_date' => esc_html__('End Date and Time', 'bookify-pro'),
															'start_date_time_with_end_date_time' => esc_html__('Start Date Time With End Date Time', 'bookify-pro'),
														),
														'default' => 'start_date',
													...
													array(
														...
														'options' => array(
															'j F, Y g:i A' => esc_html__('Default (01 January 2024 12:00 AM)', 'bookify-pro'),
															'F j, Y g:i A' => esc_html__('Default (January 01 2024 12:00 AM)', 'bookify-pro'),
															'F j, g:i A' => esc_html__('Default (January 01 12:00 AM)', 'bookify-pro'),
															'j F, g:i A' => esc_html__('Default ( 01 January 12:00 AM)', 'bookify-pro'),
															'j M, g:i A' => esc_html__('Default ( 01 Jan 12:00 AM)', 'bookify-pro'),
															'M j, g:i A' => esc_html__('Default ( Jan 01 12:00 AM)', 'bookify-pro'),
															'j F, Y' => esc_html__('Default (01 January 2024)', 'bookify-pro'),
															'F j, Y' => esc_html__('Default (January 01 2024)', 'bookify-pro'),
															'j F, Y' => esc_html__('Default (01 January 2024)', 'bookify-pro'),
															'M j, Y' => esc_html__('Default (Jan 01 2024)', 'bookify-pro'),
															'j M, Y' => esc_html__('Default (01 Jan 2024)', 'bookify-pro'),
															'g:i A' => esc_html__('Default (12:50 AM)', 'bookify-pro'),
															'G:i' => esc_html__('Default (23:00)', 'bookify-pro'),
															'custom' => esc_html__('Custom', 'bookify-pro'),
														),
														'default'   => esc_html__('j F, Y g:i A', 'bookify-pro'),
														'desc' => __('To define format, check <a href="https://wordpress.org/support/article/formatting-date-and-time/" target="_blank" rel="noopener noreferrer nofollow"><em>this doc</em></a>.', 'bookify-pro'),
														'dependency' => array('select_event_fildes', '==', 'event_time'),
													),
													array(
														'id'    => 'bop_custom_event_date_format',
														'type'  => 'text',
														'title' => ' ',
														'class' => 'bop_custom_event_date_format',
														'placeholder' => esc_html__('j F, Y g:i A', 'bookify-pro'),
														'default'   => esc_html__('j F, Y g:i A', 'bookify-pro'),
														'desc' => __('To define format, check <a href="https://wordpress.org/support/article/formatting-date-and-time/" target="_blank" rel="noopener noreferrer nofollow"><em>this doc</em></a>.', 'bookify-pro'),
											...
											array(
												...
												'type'    => 'radio',
												'title'   => esc_html__('Event Meta Separator', 'bookify-pro'),
												'options' => array(
													' '  => esc_html__('Normal Space ', 'bookify-pro'),
													'. ' => esc_html__('Full Stop ( . ) ', 'bookify-pro'),
													'| ' => esc_html__('Straight Line ( | )', 'bookify-pro'),
											...
											array(
												...
												'type'    => 'color',
												'title'   => esc_html__('Event Meta Separator Color', 'bookify-pro'),
												'default' => '#0015b5',
												'dependency' => array('show_event_fildes', '==', 'true'),
											),
											array(
									...
									array(
										...
										'fields' => array(
											...
											array(
												...
												'label' =>  __('Embed the content if it is audio, video, or tweets etc. <a target="_blank" href="https://wordpress.org/support/article/embeds/#okay-so-what-sites-can-i-embed-from">See embed supported content list.</a>', 'bookify-pro'),
											),
											array(
