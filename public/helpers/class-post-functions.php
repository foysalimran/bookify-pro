			...
			switch ( $selected_meta ) {
				...
				case 'publisher':
					if ( $bookify_postmeta['bop_publisher'] ) {
						...
						echo '<span>' . esc_html( $bookify_postmeta['bop_publisher'] ) . '</span>';
						echo wp_kses_post( $meta_tag_end );
					}
				...
				case 'publish_date':
					if ( $bookify_postmeta['bop_publish_date'] ) {
						...
						echo '<span>' . esc_html( $bookify_postmeta['bop_publish_date'] ) . '</span>';
						echo wp_kses_post( $meta_tag_end );
					}
				...
				case 'isbn':
					if ( $bookify_postmeta['bop_book_isbn'] ) {
						...
						echo '<span>' . esc_html( $bookify_postmeta['bop_book_isbn'] ) . '</span>';
						echo wp_kses_post( $meta_tag_end );
					}
				...
				case 'isbn_10':
					if ( $bookify_postmeta['bop_book_isbn_10'] ) {
						...
						echo '<span>' . esc_html( $bookify_postmeta['bop_book_isbn_10'] ) . '</span>';
						echo wp_kses_post( $meta_tag_end );
					}
				...
				case 'isbn_13':
					if ( $bookify_postmeta['bop_book_isbn_13'] ) {
						...
						echo '<span>' . esc_html( $bookify_postmeta['bop_book_isbn_13'] ) . '</span>';
						echo wp_kses_post( $meta_tag_end );
					}
				...
				case 'asin':
					if ( $bookify_postmeta['bop_book_asin'] ) {
						...
						echo '<span>' . esc_html( $bookify_postmeta['bop_book_asin'] ) . '</span>';
						echo wp_kses_post( $meta_tag_end );
					}
				...
				case 'subject':
					if ( $bookify_postmeta['bop_book_subject'] ) {
						...
						echo '<span>' . esc_html( $bookify_postmeta['bop_book_subject'] ) . '</span>';
						echo wp_kses_post( $meta_tag_end );
					}
				...
				case 'genre':
					if ( $bookify_postmeta['bop_book_genre'] ) {
						...
						echo '<span>' . esc_html( $bookify_postmeta['bop_book_genre'] ) . '</span>';
						echo wp_kses_post( $meta_tag_end );
					}
					break;
			}
